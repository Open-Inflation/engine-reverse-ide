...
| --- | --- | --- |
| `name` | Публичное имя приложения | Используется в имени пакета, в заголовках документации и в docstring-ах сгенерированного клиента. Имя должно быть без пробелов. |
